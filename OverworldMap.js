        ...
        talking: [
          {
            ...
            events: [
              { type: "textMessage", text: "Isn't Katrina the coolest?", faceHero: "npcA" },
            ]
          },
          {
            events: [
    ...
    configObjects: {
      ...
      kitchenNpcB: {
        ...
        talking: [
          {
            events: [
              { type: "textMessage", text: "Katrina is the coolest and deserves lots of kisses.", faceHero: "kitchenNpcB" },
            ]
          }
        ],
        behaviorLoop: [
